...
(function () {
    ...
    var CalendarInput = touch.CalendarInput = (function (method, options) {
        ...
        var input = options.input,
            ...
            kioskOnTop = $app.touch.kiosk('ontop'),
            touchPointer = $app.touch.pointer() === 'touch' || kioskOnTop;
        ...
        function focus(skipTouchCheck) {
            ...
            var cover = $body.find('.app-calendar-cover'),
                ...
                center = windowWidth <= 480 && windowHeight <= 480 || kioskOnTop,
    ...
    $(document)
        ...
        .on('input', '.app-data-input[data-datepicker-attached]', function (e) {
            var input = $(e.target),
                field = $app.input.eventToField(e), dv, d,
    ...
    $(document)
        ...
        .on('help.input.app', '[data-input][data-type="date"],[data-input][data-type="datetime"]', function (e) {
            ...
            e.inputElement.blur();
            $app.input.focus({ lastFocused: true });
            return false;
        });
