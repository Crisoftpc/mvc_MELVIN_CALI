            ...
            switch (fieldType) {
                ...
                case 'Currency':
                    ...
                    if (/*String.format('{0}', newValue)*/isNaN(newValue) || newValue == null)
                        ...
                        if (dataFormatString && dataFormatString.match(/:p/) && (newValue > 1 || newValue < -1))
            ...
            if (rules) {
                ...
                if (typeof rules == 'function') {
                    if (beforePhase && dataView.editing()) {
                        ...
                        dataView._validateFieldValues(actionArgs.Values, args.causesValidation, false, true);
                        if (!dataView.validate(actionArgs.Values))
                            return false;
                    }
